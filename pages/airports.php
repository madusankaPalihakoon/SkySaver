...
<body>
  ...
  <main>
    <div class="flex p-4 flex-wrap w-screen">
      ...
      <?php foreach ($airports as $airport) : ?>
        ...
        <div class="w-96">
          <h2 class=" text-gray-900 font-bold mb-2 text-xl">' . $airport['airport_name'] . '</h2>
          <img class="w-full mx-auto h-80 object-cover rounded-md hover:scale-105 transition duration-1000" src="assets/img/swiper/01.jpg" alt="">
        </div>
        <div class="w-96">
          <p class=" text-justify text-lg p-2">City :' . $airport['city'] . '</p>
          <p class=" text-justify text-lg p-2">Country : ' . $airport['country'] . '</p>
          <div class="py-4 w-full flex justify-center">
            <a class=" bg-blue-600 px-2 py-4 text-blue-50 font-semibold text-lg rounded-md hover:bg-blue-700" <a href="airport.php?id=' . $airport['airport_id'] . '&name=' . $airport['airport_name'] . '">Find out more</a>
          </div>
        </div>
      </div>';
        ?>
